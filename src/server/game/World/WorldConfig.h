...
enum ServerConfigs
{
    ...
    RATE_REGEN_HEALTH,
    RATE_REGEN_POWER_MANA,
    RATE_REGEN_POWER_RAGE_INCOME,
    RATE_REGEN_POWER_RAGE_LOSS,
    RATE_REGEN_POWER_RUNICPOWER_INCOME,
    RATE_REGEN_POWER_RUNICPOWER_LOSS,
    RATE_REGEN_POWER_ENERGY,
    RATE_REGEN_POWER_FOCUS,
    RATE_REGEN_POWER_HAPPINESS,
    RATE_REGEN_POWER_RUNES,
    RATE_POWER_FOCUS,
    RATE_POWER_ENERGY,
